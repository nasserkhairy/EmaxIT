...
<head>
  ...
  <title>Contact Us - Get a Quote</title>
  ...
  <style>
    body {
      ...
      align-items: center;
      min-height: 100vh; /* Ensures content is centered vertically on page */
    ...
    .php-email-form select {
      ...
      box-shadow: none;
      margin-bottom: 20px; /* Added margin-bottom for spacing between inputs */
    }
    
    /* Remove margin-bottom from the last input in a column to prevent excessive spacing */
    .php-email-form .col-md-6 .form-control:last-child,
    .php-email-form .col-md-6 select:last-child,
    .php-email-form .col-md-12 .form-control:last-child,
    .php-email-form .col-md-12 select:last-child,
    .php-email-form .col-md-12 textarea:last-child {
        margin-bottom: 0;
    }

    /* Adjust margin for form fields within gy-4 to prevent double spacing */
    .php-email-form .row.gy-4 > [class*="col-"] > .form-control,
    .php-email-form .row.gy-4 > [class*="col-"] > select,
    .php-email-form .row.gy-4 > [class*="col-"] > textarea {
        margin-bottom: 0; /* Bootstrap's gy-4 handles vertical spacing */
    }
    .php-email-form .row.gy-4 > [class*="col-"] {
        padding-bottom: 20px; /* Instead, add padding-bottom to the column for spacing */
    }
    ...
    @media (min-width: 992px) { /* On large devices (desktops) */
      .form-column {
          flex: 0 0 58%; /* Made the form slightly narrower to give info more space */
          max-width: 58%;
      }
      .info-column {
          flex: 0 0 42%; /* Made the info column wider */
          max-width: 42%;
      }
    }
...
<body>
  ...
  <div class="container py-5">
    <div class="row justify-content-center align-items-stretch"> <div class="col-md-10 info-column order-md-2 order-lg-1"> 
        <div class="info-section">
            <img src="{{ asset('assets/images/ivision-mt-logo.webp') }}" alt="XightStudio Logo">
            <p>
                **Request XightStudio Demo**
                <br><br>
                When you request a XightStudio demo, there's absolutely no commitment or questions asked — we
