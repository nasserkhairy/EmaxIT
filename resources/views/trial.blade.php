...
.challange_img .challange_img_inner {
    ...
    -webkit-box-shadow: 0px 27px 68px 0px rgba(0, 0, 0, 0.4) !important;
...
<section class="challange_area p_100 " style="margin-top: 120px;">
    <div class="container-fluid" style="padding: 0px 100px;">
        <div class="row">
            ...
            <div class="col-lg-7">
                ...
                <div class="challange_text_inner" style=" max-width: 100%;">
            ...
            <div class="col-lg-5 challange_img">
