...
<div class="service-container">
    <div class="container">
            ...
            <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        <!-- Tabs -->
                        <ul class="nav nav-pills mb-3">
                            <li><a class="nav-link active" data-bs-toggle="pill" href="#businessAnalysis-tab1">What We Offer</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#businessAnalysis-tab2">Real-World Impact</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#businessAnalysis-tab3">Why It Matters</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        ...
                        <ul class="nav nav-pills mb-3">
                            ...
                            <li><a class="nav-link" data-bs-toggle="pill" href="#solutionArchitecting-tab2">Real Results</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#solutionArchitecting-tab3">Build for Impact</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
        ...
        <section class="sub-service" id="artificialIntelligence">
            <div class="section-title" data-aos="fade-up">
            ...
            <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        <!-- Tabs -->
                        <ul class="nav nav-pills mb-3">
                            <li><a class="nav-link active" data-bs-toggle="pill" href="#artificialIntelligence-tab1">Why Microservices?</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#artificialIntelligence-tab2">Real-World Impact</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#artificialIntelligence-tab3">Designed for Change</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
        ...
        <section class="sub-service" id="cloudConsultation">
            <div class="section-title" data-aos="fade-up">
            ...
            <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        <!-- Tabs -->
                        <ul class="nav nav-pills mb-3">
                            <li><a class="nav-link active" data-bs-toggle="pill" href="#cloudConsultation-tab1">What We Offer</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#cloudConsultation-tab2">Real-World Impact</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#cloudConsultation-tab3">Beyond Bug Fixes</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
        ...
        <section class="sub-service" id="ecommerce">
            <div class="section-title" data-aos="fade-up">
            ...
            <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        <!-- Tabs -->
                        <ul class="nav nav-pills mb-3">
                            <li><a class="nav-link active" data-bs-toggle="pill" href="#ecommerce-tab1">What We Offer</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#ecommerce-tab2">Real-World Impact</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#ecommerce-tab3">Why It Matters</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
        ...
        <section class="sub-service" id="integrationArchitect">
            <div class="section-title" data-aos="fade-up">
            ...
            <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                ...
                <div class="col-lg-8 d-flex">
                    <div class="contract-card w-100">
                        <!-- Tabs -->
                        <ul class="nav nav-pills mb-3">
                            <li><a class="nav-link active" data-bs-toggle="pill" href="#integrationArchitect-tab1">What We Offer</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#integrationArchitect-tab2">Real-World Impact</a></li>
                            <li><a class="nav-link" data-bs-toggle="pill" href="#integrationArchitect-tab3">Why It Matters</a></li>
                        </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                        <div class="tab-content">
