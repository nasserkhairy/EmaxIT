        ...
        <div class="container">
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Application Modernization.webp') }}" alt="Team Discussion"
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    ...
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#mobile-tab1">What We
                                        Offer</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#mobile-tab2">Real-World Impact</a>
                                </li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#mobile-tab3">Why It Matters</a>
                                </li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
            ...
            <section class="sub-service" id="web">
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Web development edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#web-tab1">What We Offer</a>
                                </li>
            ...
            <section class="sub-service" id="microservices">
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Micro services edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#Microservices-tab1">Why
                                        Microservices?</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#Microservices-tab2">Real-World
                                        Impact</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#Microservices-tab3">Designed for
                                        Change</a></li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
            ...
            <section class="sub-service" id="quality">
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Quality Assurance edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#quality-tab1">What We
                                        Offer</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#quality-tab2">Real-World Impact</a>
                                </li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#quality-tab3">Beyond Bug Fixes</a>
                                </li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
            ...
            <section class="sub-service" id="devOps">
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/DevOps Services edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#devOps-tab1">What We
                                        Offer</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#devOps-tab2">Real-World Impact</a>
                                </li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#devOps-tab3">Why It Matters</a>
                                </li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
                        ...
                        <div class="contract-card w-100">
                            ...
                            <ul class="nav nav-pills mb-3">
                                ...
                                <li><a class="nav-link" data-bs-toggle="pill"
                                        href="#solutionArchitecting-tab2">Real-World Impact</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#solutionArchitecting-tab3">Why It
                                        Matters</a></li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
            ...
            <section class="sub-service" id="apiIntegration">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p>
                        ...
                        At EmaxIT International, we specialize in integrating APIs that connect systems, streamline
                        workflows, and
                        unlock new possibilities. Whether it’s payment gateways, third-party platforms, or internal
                        tools—our API
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Api integration edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#apiIntegration-tab1">What We
                                        Offer</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#apiIntegration-tab2">Real-World
                                        Impact</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#apiIntegration-tab3">Why It
                                        Matters</a></li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="apiIntegration-tab1">
                                    ...
                                    <p>Enable real-time or batch data sharing with smart error handling and
                                        transformation (XML, JSON, etc.).</p>
                                    <div class="d-flex align-items-center mt-4">
                                        <i class="bi bi-check2"></i>
                                        <h4>Third-Party API Integration</h4>
                                    </div>
                                    <p>Extend your platform with payment gateways (Stripe, PayPal), social media, AI
                                        services, and IoT devices.</p>
                                    <div class="d-flex align-items-center mt-4">
                                        <i class="bi bi-check2"></i>
                                        <h4>Security & Authentication</h4>
                                    </div>
                                    <p>Implement robust access control with OAuth 2.0, API keys, encryption, and rate
                                        limiting.</p>
                                    <div class="d-flex align-items-center mt-4">
                                        <i class="bi bi-check2"></i>
                                        <h4>Performance & Scalability</h4>
                                    </div>
                                    <p>Optimize APIs with caching, load balancing, and asynchronous processing for high
                                        availability.</p>
                                </div><!-- End Tab 1 Content -->
                                ...
                                <div class="tab-pane fade" id="apiIntegration-tab3">
                                    <p>APIs are the glue of the digital world. We help you connect smarter, scale
                                        faster, and deliver better
                                        experiences.</p>
                                </div><!-- End Tab 3 Content -->
                            </div>
                        </div>
            ...
            <section class="sub-service" id="databaseMigration">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p>
                        ...
                        Outdated databases slow your business down. At EmaxIT International, we help you migrate and
                        modernize your
                        database systems to boost speed, reduce costs, and scale with confidence—whether you’re moving
                        to the cloud or
                ...
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Database migration and modernisation edit.webp') }}"
                                alt="Team Discussion" class="img-fluid h-100">
                        </div>
                    </div>
                    <div class="col-lg-8 d-flex">
                        <div class="contract-card w-100">
                            <!-- Tabs -->
                            <ul class="nav nav-pills mb-3">
                                <li><a class="nav-link active" data-bs-toggle="pill" href="#databaseMigration-tab1">Our
                                        Services</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#databaseMigration-tab2">Real-World
                                        Results</a></li>
                                <li><a class="nav-link" data-bs-toggle="pill" href="#databaseMigration-tab3">Why It
                                        Matters</a></li>
                            </ul><!-- End Tabs -->
                            <!-- Tab Content -->
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="databaseMigration-tab1">
                                    ...
                                    <p>We assess your systems, identify risks, and define a tailored migration strategy.
                                    </p>
                                    ...
                                    <p>Securely extract, transform, and load data with minimal downtime and high
                                        integrity.</p>
                                ...
                                <div class="tab-pane fade" id="databaseMigration-tab3">
                                    <p>A modern database isn’t just faster—it’s smarter. It powers innovation, drives
                                        insights, and gives your business
