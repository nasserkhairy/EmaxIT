            ...
            <section class="sub-service" id="itConsultaion">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p>Turn Data Into Decisions.
                        At EmaxIT International, we help businesses transform raw data into actionable insights. Our
                        Data Analytics
                        Services uncover trends, explain outcomes, and forecast future possibilities—empowering smarter
                        decisions and
                        strategic growth.</p>
                </div>
                <div class="row g-0 align-items-stretch shadow-sm mt-4 sub-service-content">
                    <div class="col-lg-4 d-flex">
                        <div class="w-100 contract-img">
                            <img src="{{ asset('assets/images/services/Data analytics services edit.webp') }}"
                        ...
                        <div class="contract-card w-100">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="about-tab1">
                                    ...
                                    <p>Explore why things happened with root cause analysis, anomaly detection, and data
                                        drilling.</p>
                                    <div class="d-flex align-items-center mt-4">
                                        <i class="bi bi-check2"></i>
                                        <h4>Predictive Analytics</h4>
                                    </div>
                                    <p>Stay ahead using machine learning models that forecast behavior, demand, and
                                        risk.</p>
                                    <div class="d-flex align-items-center mt-4">
                                        <i class="bi bi-check2"></i>
                                ...
                                <div class="tab-pane fade" id="about-tab2">
                                    ...
                                    <p>Boosted customer retention and cross-sell rates by 25% with prescriptive
                                        recommendations.</p>
                                </div><!-- End Tab 2 Content -->
                                <div class="tab-pane fade" id="about-tab3">
                                    <p>Data is the new currency—if you know how to use it. We turn complex datasets into
                                        clear stories, enabling you to
