...
<body>
	<section class="ftco-section ftco-portfolio " style="margin-top: 100px;">
		<div class="container">
			<div class="row no-gutters">
				<div class="col-md-12 portfolio-wrap">
					<div class="row no-gutters align-items-center">
						<div class="col-md-5 img js-fullheight" style="background-image: url('{{ asset('assets/images/p1.png') }}');">
